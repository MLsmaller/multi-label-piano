...
#         boxes_height = find_img_key_loc(bwlabel,base_img,phase='Notest')
#         white_loc,black_boxes,total_top,total_bottom = find_img_key_loc(bwlabel,test_img)
#         new_black_boxes=[]
...
#     else:
#         white_loc,black_boxes,total_top,total_bottom = find_img_key_loc(bwlabel,base_img)
