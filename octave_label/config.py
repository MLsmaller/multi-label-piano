...
_C.EVALUATE_MAP = {
        ...
        'level_1_no_02':{'base_frame':1012,'begin_frame':117,'end_frame':1012,'label_path':'/home/lj/cy/data/piano/new/videos/Tencent/labels/level_1_no_02_label.txt','fps':25,'midi_offset':0,'rect':[28,497,1267,713],'keyboard_rect':[33,498,1258,639]},  #--x1,y1,x2,y2，
        'level_1_no_04': {'base_frame': 962, 'begin_frame':117,'end_frame': 962, 'label_path': '/home/lj/cy/data/piano/new/videos/Tencent/labels/level_1_no_04_label.txt', 'fps': 25, 'midi_offset': 0, 'rect': [29, 514, 1254, 720], 'keyboard_rect': [31, 517, 1247, 663]},
        'level_1_no_05': {'base_frame': 1096, 'begin_frame':117,'end_frame': 1096, 'label_path': '/home/lj/cy/data/piano/new/videos/Tencent/labels/level_1_no_05_label.txt', 'fps': 25, 'midi_offset': 0, 'rect': [29, 514, 1254, 720], 'keyboard_rect': [31, 517, 1247, 663]},
        
        'level_2_no_01':{'base_frame':617,'begin_frame':0,'end_frame':617,'label_path':'/home/lj/cy/data/piano/new/videos/Tencent/labels/level_2_no_01_label.txt','fps':25,'midi_offset':0,'rect':[28,497,1267,713],'keyboard_rect':[33,498,1258,639]},  #--x1,y1,x2,y2，
        'level_4_no_01': {'base_frame': 1679,'begin_frame':0,'end_frame':1679, 'label_path': '/home/lj/cy/data/piano/new/videos/Tencent/labels/level_4_no_01_label.txt', 'fps': 25, 'midi_offset': 0, 'rect': [29, 514, 1254, 720], 'keyboard_rect': [31, 517, 1247, 663]},
        'level_2_no_02': {'base_frame': 867, 'begin_frame':0,'end_frame':867,'label_path': '/home/lj/cy/data/piano/new/videos/Tencent/labels/level_2_no_02_label.txt', 'fps': 25, 'midi_offset': 0,'keyboard_rect': [36, 499, 1248, 635]},
        'level_4_no_02': {'base_frame': 2070, 'begin_frame':0,'end_frame':2070,'label_path': '/home/lj/cy/data/piano/new/videos/Tencent/labels/level_4_no_02_label.txt', 'fps': 25,'midi_offset': 0,'keyboard_crop':120,'keyboard_rect':[37,521,1249,660]},
        
        '10': {'base_frame': 564, 'begin_frame': 0, 'end_frame': 3651, 'label_path': '/home/lj/cy/data/piano/new/videos/Paper/SightToSound_paper/10_label.txt', 'fps': 29.69, 'midi_offset': 0.457, 'keyboard_crop': 120,
                'keyboard_rect':[14,19,1862,240],'label_rect':[(22,21),(1863,18),(1861,242),(13,243)]}, #--x1,y1,x2,y2 label_rect:(lt,rt,rb,lb)
...
_C.octave_size = (224, 165)  #---看看要不要随机crop一下(0.0)
_C.octave_final_size = (224, 160)
#-- path
_C.octave_train_list = '/home/lj/cy/project/piano/vision-piano-amt-master/backup/octave_label/data/binary_label/octave_train.txt'
_C.octave_val_list = '/home/lj/cy/project/piano/vision-piano-amt-master/backup/octave_label/data/binary_label/octave_val.txt'

_C.octave_ckpt_path = '/home/lj/cy/project/piano/vision-piano-amt-master/backup/octave_label/checkpoints/octave_keys_epoch_17_Acc_0.989.pth'
_C.octave_time_path = '/home/lj/cy/project/piano/vision-piano-amt-master/backup/octave_label/checkpoints/octave_time_keys_epoch_7_Acc_0.987.pth'
_C.wboctave_time_path = '/home/lj/cy/project/piano/vision-piano-amt-master/backup/octave_label/checkpoints/wb_white_octave_time_keys_epoch_0_Acc_0.980.pth'

_C.octave_num_classes = 12
#---正负样本的最低数量
_C.train_key_threshold = 100
_C.val_key_threshold = 20

#--config
_C.octave_prob_thresh = 0.4  #or 0.6
_C.octave_test_thresh = 0.7
_C.octave_top_k = 3
_C.l_offset = 8
_C.r_offset = 7

#----12个类中每个类所占的权重---
_C.octave_label_weights = [1, 4, 1, 8, 1, 3, 2, 1, 9, 1, 10, 1]
_C.octave_w = [0, 2, 4, 5, 7, 9, 11]
_C.octave_b = [1, 3, 6, 8, 10]
